						...
						<div class="col-md-12">
							<div class="card card-form">
								<form action="barang-jasa" method="post" class="user" enctype="multipart/form-data">
									...
									<div class="form-add">
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input id="vol" name="vol" type="text" class="form-control input-border-bottom" required="" value="<?= $queryIdPaket["vol"]; ?>">
									...
									<div class="form-add">
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input id="jmlh_negosiasi" name="harga_satuan" type="text" class="form-control input-border-bottom" required="" value="<?= $queryIdPaket["harga_satuan"]; ?>">
											<label for="jmlh_negosiasi" class="placeholder"><i class="bi bi-cash-stack"></i> Harga Satuan</label>
										</div>
									</div>
